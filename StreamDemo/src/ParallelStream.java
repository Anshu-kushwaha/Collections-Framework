...
public class ParallelStream {
    public static void main(String[] args) {
        ...
        // Parallel streams are most affective for CPU-intensive or large datasets where tasks are independent
        // They may add overhead for simple tasks or small datasheet
