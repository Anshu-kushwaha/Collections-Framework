...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        List<String> names = Arrays.asList("Anny", "Bob", "Charlie");
        ...
        List<Integer> nums = Arrays.asList(1, 2, 3, 4, 3, 2, 5, 6, 7, 8, 8, 9);
        ...
        System.out.println(words.stream()
                .collect(Collectors.groupingBy(String::length, Collectors.counting())));  // counting the group

        // 9. Partitioning Elements
        //  Partitioning into two groups (true and false) based on a predicate
        System.out.println(words.stream()
